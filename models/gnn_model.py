...
class DatasetProbaAEModel(torch.nn.Module):

    def __init__(self, input_size, output_size):
        super(DatasetProbaAEModel, self).__init__()
        self.linear1 = torch.nn.Linear(int(input_size), int(input_size // 1.5))
        self.activation1 = torch.nn.ReLU()
        self.linear2 = torch.nn.Linear(int(input_size // 1.5), int(input_size // (1.5 ** 2)))
        self.activation2 = torch.nn.ReLU()
        self.linear3 = torch.nn.Linear(int(input_size // (1.5 ** 2)), int(input_size // (1.5 ** 2)))
        self.activation3 = torch.nn.ReLU()
        self.linear4 = torch.nn.Linear(int(input_size // (1.5 ** 2)), int(input_size // 1.5))
        self.activation4 = torch.nn.ReLU()
        self.linear5 = torch.nn.Linear(int(input_size // 1.5), output_size)
