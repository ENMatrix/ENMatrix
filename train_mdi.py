...
def main():
    ...
    parser.add_argument('--dist_loss_delta', type=float, default=0.05)
    parser.add_argument('--dist_loss_proba', type=float, default=0.01)
    parser.add_argument('--dist_loss_iter', type=int, default=5)
    parser.add_argument('--dist_loss_cold_start_delay', type=int, default=5000)
    ...
    if args.domain == 'uci':
        ...
        datasets, index_tracking, cluster_index_lsts = load_data(args)
    elif args.domain == 'mc':
    ...
    train_gnn_mdi(datasets, args, log_path, index_tracking, cluster_index_lsts, device)
